...
\node[box, below=of fam, minimum width=42mm] (val) {validation (5{,}000 queries)};
\node[box, below left=3mm and 6mm of val] (rej) {REJECT complexity\\
  (null wins)};
\node[box, below right=3mm and 6mm of val] (adm) {ADMIT complexity\\
  (margin $A_j$)};
\node[box, below=8mm of $(rej)!0.5!(adm)$] (lock) {LOCK configuration};
\node[box, below=of lock] (test) {test access};
\node[box, below left=2mm and 4mm of test] (keep) {retained\\(margin $R_j$)};
\node[box, below right=2mm and 4mm of test] (rev) {REVERSAL\\
  reported as result};
...
\draw[-latex] (test) -- (rev);
\node[lab, right=2mm of fam] {null states declared\\before any test access};
\end{tikzpicture}
